...
public class BlockSuggestionProvider implements SuggestionProvider<FabricClientCommandSource> {
    @Override
    public CompletableFuture<Suggestions> getSuggestions(CommandContext<FabricClientCommandSource> context,
        ...
        for (var blockEntry : BuiltInRegistries.BLOCK.entrySet()) {
            ...
            String blockId = String.valueOf(blockEntry.getKey().identifier());
            // 将ID作为建议添加到builder中
